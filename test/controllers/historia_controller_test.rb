...
class HistoriaControllerTest < ActionController::TestCase
  ...
  test "should create historium" do
    assert_difference('Historium.count') do
      post :create, historium: { category_id: @historium.category_id, description: @historium.description, sprint_id: @historium.sprint_id, url: @historium.url }
    end
  ...
  test "should update historium" do
    patch :update, id: @historium, historium: { category_id: @historium.category_id, description: @historium.description, sprint_id: @historium.sprint_id, url: @historium.url }
    assert_redirected_to historium_path(assigns(:historium))
  end
